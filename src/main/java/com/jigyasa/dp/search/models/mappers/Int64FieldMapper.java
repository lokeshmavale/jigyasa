...
public class Int64FieldMapper extends FieldMapperStrategy {
    ...
    private IndexableField getSortableField(SchemaField schemaField, long val) {
    ...
    private IndexableField getFilterableDocField(SchemaField schemaField, long val) {
